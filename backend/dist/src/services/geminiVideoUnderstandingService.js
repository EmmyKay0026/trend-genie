...
exports.videoBufferUnderstandingService = exports.videoLinkUnderstandingService = exports.videoUnderstandingService = void 0;
const geminiConfig_1 = __importDefault(require("../config/geminiConfig"));
// const base64VideoFile = fs.readFileSync("path/to/small-sample.mp4", {
//   encoding: "base64",
// });
const videoLinkUnderstandingService = async (videoLink, mimeType) => {
...
exports.videoLinkUnderstandingService = videoLinkUnderstandingService;
const videoBufferUnderstandingService = async (videoLink, mimeType) => {
...
exports.videoBufferUnderstandingService = videoBufferUnderstandingService;
const videoUnderstandingService = async (file) => {
    const contents = [
        {
            inlineData: {
                mimeType: "video/mp4",
