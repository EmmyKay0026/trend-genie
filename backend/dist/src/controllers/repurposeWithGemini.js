...
exports.repurposeVideoLinkWithGemini = exports.repurposeUploadedVideo = void 0;
...
const repurposeUploadedVideo = async (res, req) => {
...
exports.repurposeUploadedVideo = repurposeUploadedVideo;
const repurposeVideoLinkWithGemini = async (req, res, videoUrl) => {
    try {
        ...
        const response = await geminiConfig_1.default.models.generateContent({
            ...
            contents: (0, genai_1.createUserContent)([
                (0, genai_1.createPartFromUri)(videoUrl, "video/mp4"),
...
exports.repurposeVideoLinkWithGemini = repurposeVideoLinkWithGemini;
